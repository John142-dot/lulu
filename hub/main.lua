...
local function onKick(reason)
    print("Kicking player for reason:", reason)
    game.Players.LocalPlayer:Kick(reason)
end

if not getgenv().Activate or not getgenv().Activate.simplescripts then
    onKick("Activate.simplescripts is not activated.")
else
    ...
    Tab:AddButton({
        ...
        Callback = function()
            game.Players.LocalPlayer.Character.Humanoid.JumpPower = 50 -- Reset to default value
        end    
    })
    ...
    Tab:AddButton({
        Name = "Un Speed",
        Callback = function()
            game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 16 -- Reset to default value
        end    
    })
